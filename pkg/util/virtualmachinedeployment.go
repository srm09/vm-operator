...
type MachineSetsByCreationTimestamp []*v1alpha2.VirtualMachineReplicaSet
...
type MachineSetsBySizeOlder []*v1alpha2.VirtualMachineReplicaSet
...
type MachineSetsBySizeNewer []*v1alpha2.VirtualMachineReplicaSet
...
func SetDeploymentRevision(deployment *v1alpha2.VirtualMachineDeployment, revision string) bool {
	updated := false

	if deployment.Annotations == nil {
		deployment.Annotations = make(map[string]string)
	}
	if deployment.Annotations[v1alpha2.RevisionAnnotation] != revision {
		deployment.Annotations[v1alpha2.RevisionAnnotation] = revision
		updated = true
	}
...
func MaxRevision(allMSs []*v1alpha2.VirtualMachineReplicaSet, logger logr.Logger) int64 {
	max := int64(0)
...
func Revision(obj runtime.Object) (int64, error) {
	...
	v, ok := acc.GetAnnotations()[v1alpha2.RevisionAnnotation]
	if !ok {
		return 0, nil
	}
...
var annotationsToSkip = map[string]bool{
	...
	v1alpha2.RevisionAnnotation:        true,
	v1alpha2.RevisionHistoryAnnotation: true,
	v1alpha2.DesiredReplicasAnnotation: true,
	v1alpha2.MaxReplicasAnnotation:     true,
}
...
func copyDeploymentAnnotationsToMachineSet(deployment *v1alpha2.VirtualMachineDeployment, ms *v1alpha2.VirtualMachineReplicaSet) bool {
...
func getMaxReplicasAnnotation(ms *v1alpha2.VirtualMachineReplicaSet, logger logr.Logger) (int32, bool) {
	return getIntFromAnnotation(ms, v1alpha2.MaxReplicasAnnotation, logger)
}

func getIntFromAnnotation(ms *v1alpha2.VirtualMachineReplicaSet, annotationKey string, logger logr.Logger) (int32, bool) {
...
func SetNewMachineSetAnnotations(deployment *v1alpha2.VirtualMachineDeployment, newMS *v1alpha2.VirtualMachineReplicaSet, newRevision string, exists bool, logger logr.Logger) bool {
	...
	oldRevision, ok := newMS.Annotations[v1alpha2.RevisionAnnotation]
	...
	if oldRevisionInt < newRevisionInt {
		newMS.Annotations[v1alpha2.RevisionAnnotation] = newRevision
	...
	if ok && annotationChanged {
		revisionHistoryAnnotation := newMS.Annotations[v1alpha2.RevisionHistoryAnnotation]
		oldRevisions := strings.Split(revisionHistoryAnnotation, ",")
		if oldRevisions[0] == "" {
			newMS.Annotations[v1alpha2.RevisionHistoryAnnotation] = oldRevision
		} else {
			oldRevisions = append(oldRevisions, oldRevision)
			newMS.Annotations[v1alpha2.RevisionHistoryAnnotation] = strings.Join(oldRevisions, ",")
		}
	}
...
func FindOneActiveOrLatest(newMS *v1alpha2.VirtualMachineReplicaSet, oldMSs []*v1alpha2.VirtualMachineReplicaSet) *v1alpha2.VirtualMachineReplicaSet {
...
func SetReplicasAnnotations(ms *v1alpha2.VirtualMachineReplicaSet, desiredReplicas, maxReplicas int32) bool {
	updated := false
	if ms.Annotations == nil {
		ms.Annotations = make(map[string]string)
	}
	desiredString := fmt.Sprintf("%d", desiredReplicas)
	if hasString := ms.Annotations[v1alpha2.DesiredReplicasAnnotation]; hasString != desiredString {
		ms.Annotations[v1alpha2.DesiredReplicasAnnotation] = desiredString
		updated = true
	}
	if hasString := ms.Annotations[v1alpha2.MaxReplicasAnnotation]; hasString != fmt.Sprintf("%d", maxReplicas) {
		ms.Annotations[v1alpha2.MaxReplicasAnnotation] = fmt.Sprintf("%d", maxReplicas)
		updated = true
	}
	return updated
}
...
func ReplicasAnnotationsNeedUpdate(ms *v1alpha2.VirtualMachineReplicaSet, desiredReplicas, maxReplicas int32) bool {
	if ms.Annotations == nil {
		return true
	}
	desiredString := fmt.Sprintf("%d", desiredReplicas)
...
func MaxUnavailable(deployment v1alpha2.VirtualMachineDeployment) int32 {
...
func MaxSurge(deployment v1alpha2.VirtualMachineDeployment) int32 {
...
func GetProportion(ms *v1alpha2.VirtualMachineReplicaSet, d v1alpha2.VirtualMachineDeployment, deploymentReplicasToAdd, deploymentReplicasAdded int32, logger logr.Logger) int32 {
...
func getMachineSetFraction(ms v1alpha2.VirtualMachineReplicaSet, d v1alpha2.VirtualMachineDeployment, logger logr.Logger) int32 {
...
func EqualMachineTemplate(template1, template2 *v1alpha2.VirtualMachineTemplateSpec) bool {
	...
	delete(t1Copy.Labels, v1alpha2.VirtualMachineDeploymentUniqueLabel)
	delete(t2Copy.Labels, v1alpha2.VirtualMachineDeploymentUniqueLabel)

	return apiequality.Semantic.DeepEqual(t1Copy, t2Copy)
}

// FindNewMachineSet returns the new MS this given deployment targets (the one with the same machine template).
func FindNewMachineSet(deployment *v1alpha2.VirtualMachineDeployment, msList []*v1alpha2.VirtualMachineReplicaSet) *v1alpha2.VirtualMachineReplicaSet {
...
func FindOldMachineSets(deployment *v1alpha2.VirtualMachineDeployment, msList []*v1alpha2.VirtualMachineReplicaSet) ([]*v1alpha2.VirtualMachineReplicaSet, []*v1alpha2.VirtualMachineReplicaSet) {
	var requiredMSs []*v1alpha2.VirtualMachineReplicaSet
	allMSs := make([]*v1alpha2.VirtualMachineReplicaSet, 0, len(msList))
...
func GetReplicaCountForMachineSets(machineSets []*v1alpha2.VirtualMachineReplicaSet) int32 {
...
func GetActualReplicaCountForMachineSets(machineSets []*v1alpha2.VirtualMachineReplicaSet) int32 {
...
func TotalMachineSetsReplicaSum(machineSets []*v1alpha2.VirtualMachineReplicaSet) int32 {
	totalReplicas := int32(0)
	for _, ms := range machineSets {
		if ms != nil {
...
func GetReadyReplicaCountForMachineSets(machineSets []*v1alpha2.VirtualMachineReplicaSet) int32 {
...
func GetAvailableReplicaCountForMachineSets(machineSets []*v1alpha2.VirtualMachineReplicaSet) int32 {
...
func IsRollingUpdate(deployment *v1alpha2.VirtualMachineDeployment) bool {
	return deployment.Spec.Strategy.Type == v1alpha2.VirtualMachineDeploymentStrategyTypeRollingUpdate
}

// DeploymentComplete considers a deployment to be complete once all of its desired replicas
// are updated and available, and no old machines are running.
func DeploymentComplete(deployment *v1alpha2.VirtualMachineDeployment, newStatus *v1alpha2.VirtualMachineDeploymentStatus) bool {
...
func NewMSNewReplicas(deployment *v1alpha2.VirtualMachineDeployment, allMSs []*v1alpha2.VirtualMachineReplicaSet, newMS *v1alpha2.VirtualMachineReplicaSet) (int32, error) {
	switch deployment.Spec.Strategy.Type {
	case v1alpha2.VirtualMachineDeploymentStrategyTypeRollingUpdate:
	...
	case v1alpha2.VirtualMachineDeploymentStrategyTypeRecreate:
		// no-op
		/*// Find the total number of machines
		currentMachineCount := TotalMachineSetsReplicaSum(allMSs)
...
func IsSaturated(deployment *v1alpha2.VirtualMachineDeployment, ms *v1alpha2.VirtualMachineReplicaSet) bool {
	if ms == nil {
		return false
	}
	desiredString := ms.Annotations[v1alpha2.DesiredReplicasAnnotation]
...
func FilterActiveMachineSets(machineSets []*v1alpha2.VirtualMachineReplicaSet) []*v1alpha2.VirtualMachineReplicaSet {
	activeFilter := func(ms *v1alpha2.VirtualMachineReplicaSet) bool {
		return ms != nil && ms.Spec.Replicas != nil && *(ms.Spec.Replicas) > 0
	}
	return FilterMachineSets(machineSets, activeFilter)
}

type filterMS func(ms *v1alpha2.VirtualMachineReplicaSet) bool

// FilterMachineSets returns machine sets that are filtered by filterFn (all returned ones should match filterFn).
func FilterMachineSets(mSes []*v1alpha2.VirtualMachineReplicaSet, filterFn filterMS) []*v1alpha2.VirtualMachineReplicaSet {
	var filtered []*v1alpha2.VirtualMachineReplicaSet
	for i := range mSes {
		if filterFn(mSes[i]) {
...
// in a machineList.
func GetDeletingMachineCount(machineList *vmopv1.VirtualMachineList) int32 {
